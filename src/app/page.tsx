...
import { CalendarIcon, Clock, Phone, MapPin, Star, User, LogOut, Bell, ShoppingCart } from 'lucide-react'
import NotificationsPanel from '@/components/notifications-panel'
import CartDrawer, { useCart } from '@/components/cart-drawer'
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            نقدم لكم تجربة طعام أصيلة مع أطباق سورية تقليدية مصنوعة من أفضل المكونات الطازجة
          </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Tabs defaultValue="menu" className="w-full">
          ...
          <TabsContent value="menu" id="menu">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-center mb-8">قائمة الطعام</h2>
